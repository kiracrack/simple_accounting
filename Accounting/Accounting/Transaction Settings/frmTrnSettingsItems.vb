...
Public Class frmTrnSettingsItems
    ...
    Public Sub FilterItem()
        Try
            ...
            msda = New MySqlDataAdapter("select id, (select itemname from tblglitem where itemcode=tblgltransactionitem.credititem) as Credit,(select itemname from tblglitem where itemcode=tblgltransactionitem.debititem) as Debit from tblgltransactionitem where trngroup='" & groupcode.Text & "' and trncode='" & trncode.Text & "'", conn)
            msda.Fill(dst, 0)
